...
This architecture describes a Laravel SaaS foundation that will be extended with a Billing & Payment Gateway Simulator module.
...
Frontend (Vue Admin + Angular Dashboard) -> Nginx -> Laravel API -> Services -> Database / Redis

Layer responsibilities:
- `Frontend (Vue Admin + Angular Dashboard)`: renders UI, handles user interaction, and calls backend APIs.
...
### Frontend (Vue Admin + Angular Dashboard)
