...
Implementation must verify current official LiqPay documentation before coding.

## Expected Configuration Fields

Use placeholder public/private credential, mode, and safe public-config names only until verified.
...
Do not claim callback fields or signature algorithms without official verification.
