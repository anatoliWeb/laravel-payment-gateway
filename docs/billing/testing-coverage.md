...
| Add backend tests for permissions | covered | `backend/tests/Feature/Billing/BillingRbacSeederTest.php`, `backend/tests/Feature/Billing/AdminBillingApiTest.php`, `backend/tests/Feature/Billing/BillingReportsPermissionTest.php` | Seeder permissions, admin gate checks, and normal-user report forbiddance are covered. |
